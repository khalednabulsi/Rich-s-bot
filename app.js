...
client.on('guildMemberAdd', member => {
    ...
    member.guild.channels.get('476526110046420994').send("Welcome to Rs Wanderers! " + "<@" + member.id + "> Enjoy your stay and don't forget to read the rules first by clicking here, <#476707469549371392> and if you have two or more accounts please add them here <#564859524826136615>. Afterwards maybe <#476863150420131840> so we can all get to know you! and feel free to mute the channels you don't need to save unwanted notifications.");
